...
const inter=Inter({subsets:['latin']}); export const metadata:Metadata={title:'TrapFeed | Hip-Hop. Culture. Unfiltered.',description:'The pulse of hip-hop, music, interviews and viral culture.'};
